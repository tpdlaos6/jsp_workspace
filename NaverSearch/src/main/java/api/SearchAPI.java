...
public class SearchAPI extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp)
        ...
        // 1. 인증 정보 설정
        String clientId = "i75kd8BAMvfx9YXvFRx6";
        String clientSecret = "AWhsZ8khoQ";
...
//        String apiURL = "https://openapi.naver.com/v1/search/webkr.json?query=" + text +"&display=10&start=" + startNum;  // json 결과
