			...
			<form method="post" enctype="multipart/form-data" name="frm">
				...
				<table>
					<tr>
						<td>
						<c:choose>
						<!-- 아래 empty 는 EL 코드. null 일때도, 빈 문자열 일때도 empty로 판단-->
							<c:when test="${empty product.pictureUrl}">
								<img src="upload/noimage.gif"><!--upload 폴더 안에 noname용 이미지를 넣어놔야 함 -->
							</c:when>
							<c:otherwise>
						...
						<td>
							<table>
								...
								<tr>
									<th>설 명</th>
									<td>
										<textarea cols="90" rows="10" name="description">${product.description}
										</textarea>
									</td>
								</tr>
							</table>
